output "foundation_contract" {
  description = "Phase 04 proof that the prod root is wired to the foundational, network, identity, and compute modules."
  value = {
    ...
    observability = module.observability.module_contract
