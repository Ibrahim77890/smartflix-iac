...
locals {
  ...
  compute_blueprint = {
    ...
    connector_ip_cidr_range = "10.30.48.0/28"
    gke_services = {
      catalog = {
        kubernetes_service_account = "catalog-ksa"
      ...
      recommendation = {
        ...
        replicas                   = 2
        response_text              = "streamflix-recommendations-prod"
        limits = {
          cpu    = "250m"
          memory = "256Mi"
        }
  ...
  data_blueprint = {
    ...
    replica_tier                      = "db-g1-small"
    firestore_database_name           = "prod-streamflix"
    ...
    buckets = {
      media_assets = {
        ...
        cors = [
          {
            origin          = ["https://streamflix.example.com"]
