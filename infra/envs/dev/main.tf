...
locals {
  ...
  network_blueprint = {
    subnets = {
      ...
      private = {
        ...
        nat_enabled           = true
        secondary_ip_ranges = {
          "dev-gke-pods"     = "10.10.64.0/18"
          "dev-gke-services" = "10.10.128.0/20"
        }
      }
      data = {
    ...
    firewall_rules = {
      allow-internal = {
        description   = "Allow internal east-west traffic inside the dev VPC."
        direction     = "INGRESS"
        priority      = 1000
  ...
  compute_blueprint = {
    ...
    connector_ip_cidr_range = "10.10.48.0/28"
    gke_services = {
      catalog = {
        kubernetes_service_account = "catalog-ksa"
      ...
      recommendation = {
        ...
        replicas                   = 1
        response_text              = "streamflix-recommendations-dev"
        limits = {
          cpu    = "250m"
          memory = "256Mi"
        }
...
module "gke_cluster" {
  ...
  cluster_secondary_range_name  = "dev-gke-pods"
